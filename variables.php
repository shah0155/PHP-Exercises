...
*/
$preTotal = ($price + ($price * $tax));
$total = $preTotal + ($preTotal * $delivery);
/*
Concatenate the variables and string literals to print the statement:
armchair: $295.44
*/
$finalProductPrince = $product . ": " . round($total, 2);
echo $finalProductPrince;
...
echo "<figure>
<img src=\"https://placehold.jp/24/e8d2ae/fff/300x300.png\" alt=\"placeholder-image\">
<figcaption> " . $finalProductPrince . "</figcaption>
</figure>";
?>